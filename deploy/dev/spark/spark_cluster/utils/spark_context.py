...
from spark_cluster.utils.spark_cluster_context_config import spark_cluster_context_config


def get_spark_context(app_name: str, is_run_on_cluster: bool = False, context_log_level: str = "WARN") -> SparkSession:
    """
