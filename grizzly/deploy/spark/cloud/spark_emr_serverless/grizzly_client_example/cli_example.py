...
from grizzly.iac_pulumi.aws.reusable_architectures.spark_emr_serverless import (
...
class SparkEmrServerlessCLIExample:
    ...
    def _copy_pulumi_files(stack_name: str) -> str:
        source_dir = os.path.dirname(
            inspect.getfile(grizzly.iac_pulumi.aws.pulumi_projects.spark_emr_serverless)
        )
