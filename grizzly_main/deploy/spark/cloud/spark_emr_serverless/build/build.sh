...
aws s3 mv "$GRIZZLY_BASE_DIR/$venv_file_path" "s3://$S3_BUCKET/temp_artifacts/venvs/"
...
aws s3 mv "$GRIZZLY_BASE_DIR/$wheel_file_path" "s3://$S3_BUCKET/temp_artifacts/package_wheel_files/"
